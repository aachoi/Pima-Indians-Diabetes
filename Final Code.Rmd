...
ggplot(data = combined, aes(x = PoolQC, y = PoolArea)) +  geom_boxplot() 
...
ggplot(data = combined, aes(x = MasVnrType, y = MasVnrArea)) +  geom_boxplot() 
...
# KitchenQual - 2 NA's
ggplot(combined, aes(KitchenQual)) + geom_bar()
combined$KitchenQual[is.na(combined$KitchenQual)] = "TA"
# Functional - 3 NA's
ggplot(combined, aes(Functional)) + geom_bar()
combined$Functional[is.na(combined$Functional)] = "Typ"
# Exterior 1st - 1 NA
ggplot(combined, aes(Exterior1st)) + geom_bar()
combined$Exterior1st[is.na(combined$Exterior1st)] = "VinylSd"
# Exterior 2nd - 1 NA
ggplot(combined, aes(Exterior2nd)) + geom_bar()
...
```{r}
set.seed(1234)
traini = sample(1:nrow(training1),nrow(training1*0.9),replace=FALSE)
